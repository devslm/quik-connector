...
#ifndef QUIK_CONNECTOR_ORDERENTITY_H
#define QUIK_CONNECTOR_ORDERENTITY_H

#include <string>
#include "OrderCommissionEntity.h"

using namespace std;

typedef struct OrderEntity {
    uint64_t orderNum;
    double flags = 0.0;
    string brokerRef;
    string userId;
    ...
    OrderCommissionEntity commission;
} OrderEntity;

#endif //QUIK_CONNECTOR_ORDERENTITY_H
